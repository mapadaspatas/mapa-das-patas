...
export const strings = {
  ...
  list: {
    ...
    allMasculine: 'Todos',
    allFeminine: 'Todas',
    activeFilters: 'Filtros em vigor',
    activeFilter: (criterion: string, value: string) => `${criterion}: ${value}`,
    removeFilter: (criterion: string, value: string) => `Tirar o filtro ${criterion}: ${value}`,
